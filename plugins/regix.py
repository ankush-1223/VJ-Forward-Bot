...
# Handle range button callback
@Client.on_callback_query(filters.regex("range_mode"))
async def range_mode_handler(client, callback_query):
    user_id = callback_query.from_user.id
    temp.FWD_SESS[user_id] = {"step": "get_start"}
    temp.FWD_SESS["__range_mode__"] = True
    await callback_query.message.edit_text("📝 Send me the first message link to begin range forwarding.")
